...
import infinitystorage.container.ContainerCraftingSettings;
import infinitystorage.gui.GuiBase;
import infinitystorage.gui.grid.stack.ClientStackItem;
import infinitystorage.network.MessageGridCraftingStart;
...
public class GuiCraftingSettings extends GuiBase {
    ...
    public void init(int x, int y) {
        startButton = addButton(x + 114, y + 33, 50, 20, t("misc.infinitystorage:start"));
