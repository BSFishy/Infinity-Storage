...
public class SideButtonGridSearchBoxMode extends SideButton {
    ...
    public String getTooltip(GuiBase gui) {
        return TextFormatting.YELLOW + gui.t("sidebutton.infinitystorage:grid.search_box_mode") + TextFormatting.RESET + "\n" + gui.t("sidebutton.infinitystorage:grid.search_box_mode." + this.gui.getGrid().getSearchBoxMode());
    }
