...
import infinitystorage.container.ContainerGridFilter;
import infinitystorage.item.ItemGridFilter;
import infinitystorage.network.MessageGridFilterUpdate;
...
public class GuiGridFilter extends GuiBase {
    ...
    public void init(int x, int y) {
        compareDamage = addCheckBox(x + 7, y + 41, t("gui.infinitystorage:grid_filter.compare_damage"), (compare & CompareUtils.COMPARE_DAMAGE) == CompareUtils.COMPARE_DAMAGE);
        compareNBT = addCheckBox(x + 7 + compareDamage.getButtonWidth() + 4, y + 41, t("gui.infinitystorage:grid_filter.compare_nbt"), (compare & CompareUtils.COMPARE_NBT) == CompareUtils.COMPARE_NBT);
    }
    ...
    public void drawForeground(int mouseX, int mouseY) {
        drawString(7, 7, t("gui.infinitystorage:grid_filter"));
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        InfinityStorage.INSTANCE.network.sendToServer(new MessageGridFilterUpdate(compare));
    }
}
