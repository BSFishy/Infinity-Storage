...
public class RecipeCategorySolderer implements IRecipeCategory {
    public static final String ID = "infinitystorage.solderer";

    private IDrawable background;

    public RecipeCategorySolderer(IGuiHelper helper) {
        background = helper.createDrawable(new ResourceLocation("infinitystorage", "textures/gui/solderer.png"), 8, 5, 162, 83);
    }
    ...
    public String getTitle() {
        return I18n.format("gui.infinitystorage:solderer");
    }
