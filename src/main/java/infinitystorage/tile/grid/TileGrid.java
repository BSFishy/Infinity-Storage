...
import infinitystorage.block.BlockGrid;
...
public class TileGrid extends TileNode implements IGrid {
    ...
    public int getEnergyUsage() {
        switch (getType()) {
            case NORMAL:
                return InfinityStorage.INSTANCE.gridUsage;
            case CRAFTING:
                return InfinityStorage.INSTANCE.craftingGridUsage;
            case PATTERN:
                return InfinityStorage.INSTANCE.patternGridUsage;
            case FLUID:
                return InfinityStorage.INSTANCE.fluidGridUsage;
            default:
                return 0;
        }
    }
    ...
    public EnumGridType getType() {
        if (type == null && worldObj.getBlockState(pos).getBlock() == InfinityStorageBlocks.GRID) {
    ...
    public String getGuiTitle() {
        return getType() == EnumGridType.FLUID ? "gui.infinitystorage:fluid_grid" : "gui.infinitystorage:grid";
    }
