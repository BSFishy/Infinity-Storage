...
import infinitystorage.network.MessageTileDataParameter;
import infinitystorage.network.MessageTileDataParameterUpdate;
...
public class TileDataManager {
    ...
    public static <T> void setParameter(TileDataParameter<T> parameter, T value) {
        InfinityStorage.INSTANCE.network.sendToServer(new MessageTileDataParameterUpdate(parameter, value));
    }
