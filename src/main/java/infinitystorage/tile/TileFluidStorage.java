...
import infinitystorage.block.BlockFluidStorage;
...
public class TileFluidStorage extends TileNode implements IFluidStorageProvider, IStorageGui, IComparable, IFilterable, IPrioritizable {
    ...
    public int getEnergyUsage() {
        return InfinityStorage.INSTANCE.fluidStorageUsage;
    }
    ...
    public EnumFluidStorageType getType() {
        if (type == null && worldObj.getBlockState(pos).getBlock() == InfinityStorageBlocks.FLUID_STORAGE) {
    ...
    public String getGuiTitle() {
        return "block.infinitystorage:fluid_storage." + getType().getId() + ".name";
    }
