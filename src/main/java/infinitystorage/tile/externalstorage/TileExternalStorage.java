...
import infinitystorage.tile.TileMultipartNode;
...
public class TileExternalStorage extends TileMultipartNode implements IItemStorageProvider, IFluidStorageProvider, IStorageGui, IComparable, IFilterable, IPrioritizable, IType {
    ...
    public int getEnergyUsage() {
        return InfinityStorage.INSTANCE.externalStorageUsage + ((itemStorages.size() + fluidStorages.size()) * InfinityStorage.INSTANCE.externalStoragePerStorageUsage);
    }
    ...
    public String getGuiTitle() {
        return "gui.infinitystorage:external_storage";
    }
