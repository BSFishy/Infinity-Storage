...
public class TileImporter extends TileMultipartNode implements IComparable, IFilterable, IType {
    ...
    public TileImporter() {
        ...
        setupClientNode(new ItemStack(InfinityStorageBlocks.IMPORTER), InfinityStorage.INSTANCE.importerUsage);
    }
    ...
    public int getEnergyUsage() {
        return InfinityStorage.INSTANCE.importerUsage + upgrades.getEnergyUsage();
    }
