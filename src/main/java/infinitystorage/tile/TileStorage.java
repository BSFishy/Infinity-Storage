...
import infinitystorage.block.BlockStorage;
...
public class TileStorage extends TileNode implements IItemStorageProvider, IStorageGui, IComparable, IFilterable, IPrioritizable {
    ...
    public int getEnergyUsage() {
        return InfinityStorage.INSTANCE.storageUsage;
    }
    ...
    public EnumItemStorageType getType() {
        if (type == null && worldObj.getBlockState(pos).getBlock() == InfinityStorageBlocks.STORAGE) {
    ...
    public String getGuiTitle() {
        return "block.infinitystorage:storage." + getType().getId() + ".name";
    }
