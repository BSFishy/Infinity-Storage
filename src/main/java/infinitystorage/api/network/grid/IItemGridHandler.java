package infinitystorage.api.network.grid;
...
public interface IItemGridHandler {
     ...
     *
     * @param hash   The hash of the item we're trying to extract, see {@link infinitystorage.api.network.NetworkUtils#getItemStackHashCode(ItemStack)}
     ...
     *
     * @param hash     The hash of the item we're requesting crafting for, see {@link infinitystorage.api.network.NetworkUtils#getItemStackHashCode(ItemStack)}
