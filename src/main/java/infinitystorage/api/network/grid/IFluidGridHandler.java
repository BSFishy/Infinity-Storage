...
public interface IFluidGridHandler {
     ...
     *
     * @param hash   The hash of the fluid we're trying to extract, see {@link infinitystorage.api.network.NetworkUtils#getFluidStackHashCode(net.minecraftforge.fluids.FluidStack)}
