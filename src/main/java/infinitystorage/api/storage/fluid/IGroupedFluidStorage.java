package infinitystorage.api.storage.fluid;
...
public interface IGroupedFluidStorage {
    ...
    /**
     * Gets a fluid from the network by hash, see {@link infinitystorage.api.network.NetworkUtils#getFluidStackHashCode(FluidStack)}.
     *
